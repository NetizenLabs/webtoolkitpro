...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/blog/jwt-security-guide/', destination: '/blog/jwt-security-best-practices/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know', destination: '/blog/20-must-know-regex-patterns/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know/', destination: '/blog/20-must-know-regex-patterns/', permanent: true },
      ...
      { source: '/blog/ai-seo-optimization-2026/', destination: '/blog/geo-future-of-seo/', permanent: true },
      { source: '/blog/edge-computing-performance-2026', destination: '/blog/edge-computing-core-web-vitals/', permanent: true },
      { source: '/blog/edge-computing-performance-2026/', destination: '/blog/edge-computing-core-web-vitals/', permanent: true },
