...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/blog/slug-generator-vs-manual-entry/', destination: '/blog/url-slug-seo-best-practices/', permanent: true },
      { source: '/blog/wordpress-cron-vs-linux-cron', destination: '/blog/cron-syntax-complete-reference/', permanent: true },
      { source: '/blog/wordpress-cron-vs-linux-cron/', destination: '/blog/cron-syntax-complete-reference/', permanent: true },
      { source: '/blog/animate-css-gradients-performance', destination: '/blog/performance-optimization-guide/', permanent: true },
      { source: '/blog/animate-css-gradients-performance/', destination: '/blog/performance-optimization-guide/', permanent: true },
      { source: '/blog/jwt-decoder-tools-compared', destination: '/blog/what-is-jwt-complete-guide/', permanent: true },
      { source: '/blog/jwt-decoder-tools-compared/', destination: '/blog/what-is-jwt-complete-guide/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know', destination: '/blog/regex-cheat-sheet-javascript/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know/', destination: '/blog/regex-cheat-sheet-javascript/', permanent: true },
      { source: '/blog/how-diff-algorithms-work-myers', destination: '/blog/what-is-unified-diff/', permanent: true },
      { source: '/blog/how-diff-algorithms-work-myers/', destination: '/blog/what-is-unified-diff/', permanent: true },
      { source: '/blog/jwt-security-best-practices', destination: '/blog/what-is-jwt-complete-guide/', permanent: true },
      { source: '/blog/jwt-security-best-practices/', destination: '/blog/what-is-jwt-complete-guide/', permanent: true },
      { source: '/blog/htaccess-vs-wordpress-redirect-plugins', destination: '/blog/', permanent: true },
      { source: '/blog/htaccess-vs-wordpress-redirect-plugins/', destination: '/blog/', permanent: true },
      { source: '/blog/linear-vs-radial-vs-conic-gradients', destination: '/blog/', permanent: true },
      { source: '/blog/linear-vs-radial-vs-conic-gradients/', destination: '/blog/', permanent: true },
      ...
      { source: '/deals/\\$1;/', destination: '/', permanent: true },
      { source: '/assets/og-image.png', destination: '/og-image.png', permanent: true },
      { source: '/blog/:path*.jpg', destination: '/og-image.png', permanent: true },
