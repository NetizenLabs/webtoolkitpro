...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/blog/linear-vs-radial-vs-conic-gradients/', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/geo-future-of-seo', destination: '/blog/', permanent: true },
      { source: '/blog/geo-future-of-seo/', destination: '/blog/', permanent: true },
      ...
      { source: '/tools/robots-txt-generator/', destination: '/tools/robots-txt-toolkit/', permanent: true },
      { source: '/blog/webtoolkit-pro-trust-network', destination: '/about/', permanent: true },
      { source: '/blog/webtoolkit-pro-trust-network/', destination: '/about/', permanent: true },
      { source: '/tools/json-ld-generator', destination: '/tools/schema-markup-generator/', permanent: true },
      { source: '/tools/json-ld-generator/', destination: '/tools/schema-markup-generator/', permanent: true },
