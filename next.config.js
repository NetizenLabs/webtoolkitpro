...
const nextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/blog/linear-vs-radial-vs-conic-gradients/', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/uuid-v4-vs-v7-comparison', destination: '/tools/bulk-uuid-v4-v7-generator/', permanent: true },
      { source: '/blog/uuid-v4-vs-v7-comparison/', destination: '/tools/bulk-uuid-v4-v7-generator/', permanent: true },
      { source: '/blog/geo-future-of-seo', destination: '/blog/', permanent: true },
      { source: '/blog/geo-future-of-seo/', destination: '/blog/', permanent: true },
      { source: '/blog/cron-expression-examples', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/cron-expression-examples/', destination: '/tools/cron-generator/', permanent: true },
      ...
      { source: '/blog/add-favicon-wordpress-2026/', destination: '/blog/', permanent: true },
      { source: '/blog/jwt-vs-paseto-vs-session-tokens', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/jwt-vs-paseto-vs-session-tokens/', destination: '/tools/jwt-decoder-generator/', permanent: true },
      ...
      { source: '/blog/diff-tools-for-wordpress/', destination: '/blog/', permanent: true },
      { source: '/blog/llms-txt-generator-guide', destination: '/blog/', permanent: true },
      { source: '/blog/llms-txt-generator-guide/', destination: '/blog/', permanent: true },
      { source: '/blog/css-gradient-generators-compared', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/css-gradient-generators-compared/', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/test-htaccess-redirects', destination: '/blog/', permanent: true },
      { source: '/blog/test-htaccess-redirects/', destination: '/blog/', permanent: true },
      { source: '/blog/excel-vs-google-sheets-json', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/excel-vs-google-sheets-json/', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/wordpress-rest-api-export-csv', destination: '/blog/', permanent: true },
      { source: '/blog/wordpress-rest-api-export-csv/', destination: '/blog/', permanent: true },
      ...
      { source: '/blog/serverless-computing-future/', destination: '/blog/', permanent: true },
      { source: '/blog/rsa-key-pair-generator', destination: '/blog/', permanent: true },
      { source: '/blog/rsa-key-pair-generator/', destination: '/blog/', permanent: true },
      ...
      { source: '/blog/typescript-best-practices-2026/', destination: '/blog/', permanent: true },
      { source: '/blog/animate-css-gradients-performance', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/animate-css-gradients-performance/', destination: '/tools/css-generators/', permanent: true },
      { source: '/blog/how-diff-algorithms-work-myers', destination: '/blog/', permanent: true },
      { source: '/blog/how-diff-algorithms-work-myers/', destination: '/blog/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/regex-patterns-every-developer-should-know/', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/jwt-security-best-practices', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/jwt-security-best-practices/', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/slug-generator-vs-manual-entry', destination: '/blog/', permanent: true },
      { source: '/blog/slug-generator-vs-manual-entry/', destination: '/blog/', permanent: true },
      { source: '/blog/wordpress-cron-vs-linux-cron', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/wordpress-cron-vs-linux-cron/', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/jwt-decoder-tools-compared', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/jwt-decoder-tools-compared/', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/json-to-csv-converters-compared', destination: '/tools/csv-json-xml-converter/', permanent: true },
      { source: '/blog/json-to-csv-converters-compared/', destination: '/tools/csv-json-xml-converter/', permanent: true },
      { source: '/blog/llm-latency-ux-impact', destination: '/blog/', permanent: true },
      { source: '/blog/llm-latency-ux-impact/', destination: '/blog/', permanent: true },
      { source: '/blog/decode-jwt-without-library', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/decode-jwt-without-library/', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/geo-optimization-guide', destination: '/blog/', permanent: true },
      { source: '/blog/geo-optimization-guide/', destination: '/blog/', permanent: true },
      { source: '/blog/password-security-enterprise-2026', destination: '/tools/password-entropy-tester/', permanent: true },
      { source: '/blog/password-security-enterprise-2026/', destination: '/tools/password-entropy-tester/', permanent: true },
      { source: '/blog/ai-seo-optimization-2026', destination: '/blog/', permanent: true },
      { source: '/blog/ai-seo-optimization-2026/', destination: '/blog/', permanent: true },
      { source: '/blog/how-to-fix-common-json-errors', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/how-to-fix-common-json-errors/', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/regex-javascript-vs-python-vs-php', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/regex-javascript-vs-python-vs-php/', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/wordpress-permalink-structures-compared', destination: '/blog/', permanent: true },
      { source: '/blog/wordpress-permalink-structures-compared/', destination: '/blog/', permanent: true },
      { source: '/blog/cron-builders-compared', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/cron-builders-compared/', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/favicon-generator-tools-compared', destination: '/blog/', permanent: true },
      { source: '/blog/favicon-generator-tools-compared/', destination: '/blog/', permanent: true },
      { source: '/blog/jwt-signing-guide', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/jwt-signing-guide/', destination: '/tools/jwt-decoder-generator/', permanent: true },
      { source: '/blog/json-vs-xml-comparison', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/json-vs-xml-comparison/', destination: '/tools/json-formatter/', permanent: true },
      { source: '/blog/cron-expression-generator-2026', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/cron-expression-generator-2026/', destination: '/tools/cron-generator/', permanent: true },
      { source: '/blog/what-is-llms-txt', destination: '/blog/', permanent: true },
      { source: '/blog/what-is-llms-txt/', destination: '/blog/', permanent: true },
      { source: '/blog/best-diff-checker-tools-2026', destination: '/blog/', permanent: true },
      { source: '/blog/best-diff-checker-tools-2026/', destination: '/blog/', permanent: true },
      { source: '/blog/fix-bad-slugs-without-losing-rankings', destination: '/blog/', permanent: true },
      { source: '/blog/fix-bad-slugs-without-losing-rankings/', destination: '/blog/', permanent: true },
      { source: '/blog/how-to-debug-regex', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/how-to-debug-regex/', destination: '/tools/regex-tester/', permanent: true },
      { source: '/blog/llms-txt-vs-robots-txt', destination: '/blog/', permanent: true },
      { source: '/blog/llms-txt-vs-robots-txt/', destination: '/blog/', permanent: true },
