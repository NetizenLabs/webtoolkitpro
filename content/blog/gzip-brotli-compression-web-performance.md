...
Want an instant performance grade? Use our free [Compression Test Tool](/tools/compression-test/) to verify if Gzip and Brotli are correctly enabled on your servers →
