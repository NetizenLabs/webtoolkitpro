...
import { FileJson, FileCode, ArrowRight, Copy, Check, RotateCcw, AlertCircle } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-[#0D1526] border border-gray-100 dark:border-[#1E2D47] rounded-3xl p-8 shadow-sm">
          ...
          <textarea
            ...
            placeholder='{ "project": "WebToolkit", "active": true }'
          ...
          />
          <button onClick={convertJsonToYaml} className="w-full mt-6 py-4 bg-blue-600 text-white rounded-xl font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-blue-700 transition-all">
            Convert to YAML <ArrowRight className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-[#0D1526] border border-gray-100 dark:border-[#1E2D47] rounded-3xl p-8 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 dark:text-white">YAML Output</h3>
            </div>
            {output && (
