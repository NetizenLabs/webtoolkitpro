...
// @ts-ignore
export default function SEOToolLayout({ tool, categorySlug, relatedTools, softwareSchema }) {
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col gap-16">
          ...
          <section className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-gray-100 dark:border-[#1E2D47]">
